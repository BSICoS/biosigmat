function refined = refinepeaksInterp(signal, fs, candidates, varargin)
% REFINEPEAKSINTERP Refines peak positions using high-resolution interpolation.
%
%   REFINED = REFINEPEAKSINTERP(SIGNAL, FS, CANDIDATES)
...
%
%   REFINED = REFINEPEAKSINTERP(..., 'Name', Value) specifies
...
%     refined2 = refinepeaksInterp(signal, fs, candidates, ...
...
parser = inputParser;
parser.FunctionName = 'refinepeaksInterp';
